...
/**
 * Minimal DatabaseMetaData implementation for PrimusDB
 */
public class PrimusDBDatabaseMetaData implements DatabaseMetaData {

    private final PrimusDBConnection connection;

    public PrimusDBDatabaseMetaData(PrimusDBConnection connection) {
    ...
    public String getURL() throws SQLException {
        return "jdbc:primusdb://" + connection.getBaseUrl().substring(7);
    }
    ...
    // Minimal implementations - most methods return false/defaults
    ...
    @Override public ResultSet getColumnPrivileges(String catalog, String schemaPattern, String table, String columnNamePattern) throws SQLException { return null; }
    ...
    @Override public ResultSet getBestRowIdentifier(String catalog, String schemaPattern, String table, int scope, boolean nullable) throws SQLException { return null; }
    @Override public ResultSet getVersionColumns(String catalog, String schemaPattern, String table) throws SQLException { return null; }
    @Override public ResultSet getPrimaryKeys(String catalog, String schemaPattern, String table) throws SQLException { return null; }
    @Override public ResultSet getImportedKeys(String catalog, String schemaPattern, String table) throws SQLException { return null; }
    @Override public ResultSet getExportedKeys(String catalog, String schemaPattern, String table) throws SQLException { return null; }
    ...
    @Override public ResultSet getIndexInfo(String catalog, String schemaPattern, String table, boolean unique, boolean approximate) throws SQLException { return null; }
    ...
    @Override public boolean supportsResultSetHoldability(int holdability) throws SQLException { return holdability == ResultSet.CLOSE_CURSORS_AT_COMMIT; }
    ...
    @Override public int getDatabaseMinorVersion() throws SQLException { return 1; }
